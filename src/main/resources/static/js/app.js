...
bulkApp.factory('MockService', 
		...
		me.getUserMessages = function(d) {
	     /*
				 ...
				 * return response.data; }, function(err) {
				 * console.log('get user messages error, err: ' +
...
bulkApp.directive('autolinker', ['$timeout',
  function($timeout) {
	  return {
	    restrict: 'A',
